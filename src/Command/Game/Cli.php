...
use ChessServer\Command\Game\Sync\ExtractCommand;
use ChessServer\Command\Game\Sync\HeuristicCommand;
use ChessServer\Command\Game\Sync\LeaveCommand;
use ChessServer\Command\Game\Sync\PlayCommand;
use ChessServer\Command\Game\Sync\PlayLanCommand;
use ChessServer\Command\Game\Sync\PlayRavCommand;
use ChessServer\Command\Game\Sync\RecognizerCommand;
use ChessServer\Command\Game\Sync\ResignCommand;
use ChessServer\Command\Game\Sync\RestartCommand;
use ChessServer\Command\Game\Sync\StockfishCommand;
