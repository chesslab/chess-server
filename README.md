...
/start {"variant":["960","capablanca","classical"],"mode":["gm","fen","pgn","rav","play","stockfish"],"settings":{"color":["w","b"],"fen":"<string>","movetext":"<string>","settings":"<string>","startPos":"<string>"}} Starts a new game.
